...
(function () {
  ...
  // hide meshes whose name (or material name) contains any listed substring
  // — used to drop stray props like a scanned licence plate on a model.
