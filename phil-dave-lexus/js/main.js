...
(function () {
  ...
  function updateNextBay() {
    ...
    if (!miniReady) return;
    (miniMod ? Promise.resolve(miniMod) : import("./minispin.js?v=6").then(function (m) { miniMod = m; return m; }))
  ...
  window.__pdLexusSpin = function (id, sectionEl) {
    ...
    (lexSpin ? Promise.resolve(lexSpin) : import("./lexusspin.js?v=6").then(function (m) { lexSpin = m; return m; }))
      .then(function (m) {
  ...
  function loadLexusTool() {
    ...
    mount.__loaded = true;
    fetch("lexus-2026.html?v=6").then(function (r) { return r.text(); }).then(function (txt) {
  ...
  function startSheetSpin(c) {
    ...
    (spinMod ? Promise.resolve(spinMod) : import("./sheetspin.js?v=6").then(function (m) { spinMod = m; return m; }))
